...
It can be specified in the `.qmd` source with `{.aralt}` instead of `{.ar}`. 
...
[our `_quarto.yml` file](https://github.com/adamiturabi/quarto-arabic-mwe/blob/main/_quarto.yml):
