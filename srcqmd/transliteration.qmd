...
|[ن]{.ar}      | [n]{.trn}           | `n`|
|[ه]{.ar}      | [h]{.trn}           | `h`|
|[و]{.ar} (C/V)| [w]{.trn}/[U]{.trn} | `w`|
|[ي]{.ar} (C/V)| [y]{.trn}/[I]{.trn} | `y`|
...
For the Latin font used in your main text, you will need to pick a font that supports the dots, macrons, breves, etc needed for transliteration. I am using the 
