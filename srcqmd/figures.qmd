...
+ `template_html`: Common TikZ template code for HTML output. 
  ...
  Also note that the font is scaled by a factor of 1.275. This number has been arrived at using the following reasoning. 
  The default font size for the Tex documentclass is 10pt. 
  Inspecting the stylesheet for the this web page shows us thet the body text font size is 17px. Using the ratio of 92px = 72pt, we calculate that we need to have a font size of 12.75pt. 
  So we apply a scale factor of 1.275 to the default 10pt font size.
